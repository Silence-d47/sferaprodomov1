...
const ServiceHub: React.FC = () => {
  ...
  return (
    <div
      className={`fixed left-1/2 transform -translate-x-1/2 bottom-4 md:bottom-10 z-20 transition-all duration-700 ease-out ${
        isScrolled
    ...
    >
      <div className="service-hub-container">
        ...
        <div className="hidden md:block">
          <div
            className={`flex items-center gap-6 p-8 bg-black/40 backdrop-blur-3xl border border-white/20 rounded-3xl shadow-[0_25px_50px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.1)_inset] transition-all duration-300 ${
              ...
              >
                ...
                >
                  <Image
                    ...
                    alt={service.title}
                    width={
                      isScrolled && !hoveredService ? 32 : hoveredService === service.id ? 48 : 64
                    }
                    height={
                      isScrolled && !hoveredService ? 32 : hoveredService === service.id ? 48 : 64
                    }
                ...
                {hoveredService === service.id && (
                  <div className="absolute bottom-3 left-1/2 transform -translate-x-1/2">
                    ...
                    >
                      <Link href={service.link}>Více &gt;</Link>
                    </Button>
                  </div>
                )}
              </div>

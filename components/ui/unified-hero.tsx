        ...
        <div className="embla__container h-full flex">
          {slides.map((slide, index) => (
            <div
              ...
              className="embla__slide relative h-full overflow-hidden min-w-full flex-[0_0_100%]"
            >
      ...
      <div className="relative z-30 h-full flex items-center justify-center px-4 sm:px-6 md:px-8">
        <div className="w-full max-w-5xl mx-auto text-center">
          ...
          <div
            ...
            className="w-full max-w-[95%] sm:max-w-3xl mx-auto bg-gradient-to-br from-white/10 via-white/15 to-white/5 backdrop-blur-lg rounded-2xl md:rounded-3xl p-5 sm:p-7 md:p-8 shadow-[0_8px_32px_rgba(0,0,0,0.2)] border border-white/20 relative overflow-hidden z-40 mt-8 md:mt-0"
          >
              ...
              >
                ...
                >
                  {currentSlideData.description && (
                    <p
                      className="text-xs sm:text-base md:text-lg text-white leading-relaxed mb-5 sm:mb-8 max-w-xl mx-auto font-medium"
                      style={{ textShadow: '0 2px 8px rgba(0,0,0,0.5), 0 1px 3px rgba(0,0,0,0.8)' }}
                    >
                      {currentSlideData.description}
                    </p>
                  )}
                ...
                >
                  {currentSlideData.primaryButton?.isActive !== false && (
                    <Button
                      asChild
                      size="sm"
                      className="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-bold h-10 sm:h-11 md:h-12 rounded-md shadow-md transition-all duration-200 hover:shadow-lg border-0 text-xs sm:text-sm md:text-base relative z-50 px-2 sm:px-3 md:px-4 truncate"
                    >
                      <Link
                        href={currentSlideData.primaryButton?.link || '/kontakt'}
                      ...
                      >
                        ...
                        <span className="truncate">
                          {currentSlideData.primaryButton?.text || 'Nezávazná nabídka'}
                        </span>
                      </Link>
                    </Button>
                  )}
                  ...
                  {currentSlideData.secondaryButton?.isActive !== false && (
                    <Button
                      asChild
                      size="sm"
                      className="flex-1 bg-white/20 hover:bg-white/30 text-white font-bold h-10 sm:h-11 md:h-12 rounded-md border border-white/30 hover:border-white/50 transition-all duration-200 backdrop-blur-sm hover:shadow-md text-xs sm:text-sm md:text-base relative z-50 px-2 sm:px-3 md:px-4 truncate"
                    >
                      <Link
                        href={
                          currentSlideData.secondaryButton?.link ||
                          `tel:${currentSlideData.phoneNumber || '+420735014112'}`
                        }
                        className="flex items-center justify-center gap-1 sm:gap-2 w-full"
                      >
                        <Phone className="min-w-4 h-4 sm:min-w-5 sm:h-5 md:min-w-5 md:h-5" />
                        <span className="truncate">
                          {currentSlideData.secondaryButton?.text || 'Zavolejte nám'}
                        </span>
                      </Link>
                    </Button>
                  )}

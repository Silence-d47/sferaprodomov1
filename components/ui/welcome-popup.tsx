...
export function WelcomePopup({ isOpen, onClose }: WelcomePopupProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Popup */}
      <div className={`relative bg-white rounded-3xl shadow-2xl max-w-2xl w-full mx-4 overflow-hidden transition-all duration-500 transform ${
        ...
        >
          <X className="h-6 w-6 text-slate-600 group-hover:text-slate-800" />
        </button>
          ...
          <div className="mb-8">
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <span className="text-slate-700">Nezávazná konzultace a nacenění zdarma</span>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                <span className="text-slate-700">Návrh řešení na míru (klimatizace, tepelná čerpadla, FVE)</span>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" />
                <span className="text-slate-700">Garance 5% slevy na finální realizaci</span>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-12 text-base bg-white border-slate-200 focus:border-blue-500 focus:ring-blue-500/50"
                />
              ...
              <div className="relative">
                <Input
                  ...
                  defaultValue="+420"
                  required
                  className="h-12 text-base bg-white border-slate-200 focus:border-blue-500 focus:ring-blue-500/50 pl-12"
                />
                <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-slate-400" />
                <span className="absolute left-10 top-1/2 transform -translate-y-1/2 text-slate-400 text-sm"></span>
              </div>
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-4 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-lg h-14"
              >
                {isSubmitting ? (
                  <>

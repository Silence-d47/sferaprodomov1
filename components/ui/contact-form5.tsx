      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
        ...
        <div className="lg:col-span-2 space-y-10 pt-4">
          ...
          <div className="space-y-4">
            <a href="tel:+420735014112" className="flex items-center gap-4 group">
              ...
              <span className="font-medium text-slate-700 group-hover:text-yellow-600 transition-colors">+420 735 014 112</span>
            </a>
            <a href="mailto:info@sfera-pro-domov.cz" className="flex items-center gap-4 group">
              <Mail className="h-5 w-5 text-yellow-500" />
              <span className="font-medium text-slate-700 group-hover:text-yellow-600 transition-colors">info@sfera-pro-domov.cz</span>
            </a>
            <div className="flex items-center gap-4">
        ...
        <div className="lg:col-span-3 bg-white p-8 sm:p-10 rounded-2xl shadow-lg">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-2">
              <Button type="submit" disabled={isSubmitting} className={`w-full ${theme.primaryBg} ${theme.primaryHover} text-white font-bold py-3 text-base rounded-lg shadow-lg shadow-yellow-500/30 hover:shadow-xl hover:shadow-yellow-500/40 transition-all duration-300 flex items-center justify-center gap-2`}>
                {isSubmitting ? (
                  <>
            ...
            <p className="text-xs text-slate-500 text-center pt-2">
              Odesláním formuláře souhlasíte s našimi <Link href="/gdpr" className="font-medium text-slate-600 hover:text-yellow-600 underline">zásadami ochrany os. údajů</Link>.
            </p>
          </form>
        </div>
      </div>

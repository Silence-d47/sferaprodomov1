...
import { type ConversionData } from '@/hooks/use-conversion-metrics'
      ...
      <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-2xl max-w-[95vw] sm:max-w-2xl w-full mx-2 sm:mx-4 overflow-hidden animate-fade-in-up">
        ...
        {onClose && (
          ...
          >
            ...
            <svg
              className="h-4 w-4 sm:h-5 sm:w-5 text-slate-600 group-hover:text-slate-800 transition-colors"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
        ...
        <div className="p-4 sm:p-5 md:p-6 lg:p-8">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-base md:text-lg text-slate-600 max-w-sm sm:max-w-xl mx-auto animate-fade-in-up animation-delay-200 leading-relaxed">
              Vaše poptávka byla úspěšně odeslána. Naše odborná konzultace je zdarma a brzy se vám
              ozveme.
            </p>
          </div>
          ...
          {conversionData && (
            <div className="bg-slate-50/70 rounded-lg sm:rounded-xl p-3 sm:p-4 mb-4 sm:mb-6 border border-slate-200 animate-fade-in-up animation-delay-300">
              <h3 className="text-sm sm:text-base font-semibold text-slate-800 mb-2 sm:mb-3">
                Detaily vaší poptávky
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 text-xs sm:text-sm">
                <div className="animate-fade-in-left animation-delay-400">
                  ...
                  <span className="ml-1.5 sm:ml-2 font-medium text-slate-800">
                    {getSourceLabel(conversionData.source)}
                  </span>
                </div>
          ...
          <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3 justify-center animate-fade-in-up animation-delay-700">
            <Button
              asChild
              className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg sm:rounded-xl text-sm sm:text-base h-10 sm:h-12 hover:scale-105 transition-all duration-300 hover:shadow-xl"
            >
              <Link href="/kontakt">
            ...
            <Button
              asChild
              variant="outline"
              className="border-2 border-slate-200 hover:border-slate-300 text-slate-700 font-semibold py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg sm:rounded-xl text-sm sm:text-base h-10 sm:h-12 hover:scale-105 transition-all duration-300 hover:shadow-lg"
            >
              <Link href="/reference">

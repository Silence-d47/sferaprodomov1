      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
        ...
        <div className="lg:col-span-3 bg-white p-8 sm:p-10 rounded-2xl shadow-lg">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-2">
              <Button type="submit" disabled={isSubmitting} className={`w-full ${theme.primaryBg} ${theme.primaryHover} text-white font-bold py-3 text-base rounded-lg shadow-lg shadow-green-500/30 hover:shadow-xl hover:shadow-green-500/40 transition-all duration-300 flex items-center justify-center gap-2`}>
                {isSubmitting ? (
                  <>
            ...
            <p className="text-xs text-slate-500 text-center pt-2">
              Odesláním formuláře souhlasíte s našimi <Link href="/gdpr" className="font-medium text-slate-600 hover:text-green-600 underline">zásadami ochrany os. údajů</Link>.
            </p>
          </form>
        </div>
      </div>

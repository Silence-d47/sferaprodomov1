        ...
        <div className="mt-4 pt-4 border-t border-gray-200">
          ...
          <ul className="space-y-2">
            {features.map((feature, i) => (
              <li
                key={i}
                className="flex items-start group hover:bg-gray-50 p-2 rounded-lg transition-all duration-200"
              >
                ...
                <span className="leading-relaxed text-gray-700 group-hover:text-gray-900 transition-colors duration-200 text-sm">
                  {feature}
                </span>
              </li>
            ))}

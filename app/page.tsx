...
const services = [
  {
    ...
    title: 'Klimatizace',
    description:
      'Profesionální instalace klimatizací léty prověřených značek s nadstandardním servisem',
  ...
  },
  {
    ...
    description:
      'Kompletní elektroinstalace od drobných oprav, rekonstrukcí bytu, novostaveb až po chytrou domácnost',
  ...
  return (
    <>
      ...
      <section className="relative">
        ...
        <OrganicWaveDivider />
        <div className="pt-0">
          <LogoCarousel speed="medium" direction="left" pauseOnHover={false} />
        </div>
      </section>

      <section className="relative py-20 bg-gradient-to-b from-white via-white to-blue-100/50 overflow-hidden">
        ...
        <div className="relative z-2">
          <div className="text-center">
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-gray-900 leading-tight">
              Naše
              <span className="bg-gradient-to-r from-[#1B5D93] to-[#2D78AD] bg-clip-text text-transparent">
                {' '}
                služby
              </span>
            </h2>
          ...
          <div className="flex flex-wrap justify-center items-start gap-12 md:gap-16 max-w-6xl mx-auto">
            {services.map((service) => (
              <Link
                key={service.id}
                href={`/${service.id}`}
                className="flex justify-center relative w-64 group cursor-pointer"
              >
                <div
                  className={`${service.cardColor} p-6 pl-16 w-full text-left shadow-md rounded-lg transition-all duration-500 ease-out group-hover:shadow-2xl group-hover:scale-105 group-hover:-translate-y-2`}
                >
                ...
                <div
                  className={`w-16 h-16 ${service.color} flex items-center justify-center shadow-lg rounded-lg absolute -left-4 top-1/2 transform -translate-y-1/2 z-10 transition-all duration-500 ease-out group-hover:scale-110 group-hover:shadow-xl group-hover:-translate-y-3 group-hover:rotate-3`}
                >
                  <Image
                    src={service.iconSrc}
                    alt={service.title}
                    width={56}
                    height={56}
                    className={`w-8 h-8 ${service.iconColor} transition-transform duration-300 group-hover:scale-110`}
                  />
                </div>
              </Link>
            ))}
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Každý projekt je pro nás závazkem kvality a preciznosti. Prohlédněte si, jak jsme
              pomohli našim zákazníkům.
            </p>
          </div>
          ...
          <div className="mt-16 text-center">
            <Button
              asChild
              size="lg"
              className="group rounded-full bg-gradient-to-r from-[#1B5D93] to-[#2D78AD] px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:shadow-[#2D78AD]/40"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative">
            ...
            <div className="text-left">
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                <span className="bg-gradient-to-r from-[#1B5D93] to-[#2D78AD] bg-clip-text text-transparent font-semibold">
                  Rodinná firma
                </span>{' '}
                z Ostravy, která už řadu let pomáhá domácnostem v{' '}
                <span className="bg-gradient-to-r from-[#1B5D93] to-[#2D78AD] bg-clip-text text-transparent font-semibold">
                  Moravskoslezském a Olomouckém kraji
                </span>{' '}
                zlepšit{' '}
                <span className="bg-gradient-to-r from-[#1B5D93] to-[#2D78AD] bg-clip-text text-transparent font-semibold">
                  komfort bydlení
                </span>
                . Zakládáme si na kvalitním provedení a{' '}
                <span className="bg-gradient-to-r from-[#1B5D93] to-[#2D78AD] bg-clip-text text-transparent font-semibold">
                  rychlém
                </span>{' '}
                zákazníckém servisu.
          ...
          <div className="mt-20 z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <p className="text-lg text-gray-600 leading-relaxed">
                Zajistíme kompletní řešení pro váš komfortní a úsporný domov. Nabízíme bezpečné
                elektroinstalace, výrobu vlastní elektřiny pomocí fotovoltaických elektráren,
                rekuperace pro efektivní výměnu čerstvého vzduchu, letní chlazení klimatizacemi i
                zimní vytápění tepelnými čerpadly. Vše realizujeme z komponentů léty ověřených
                výrobců, které nakupujeme u{' '}
                <span className="bg-gradient-to-r from-[#1B5D93] to-[#2D78AD] bg-clip-text text-transparent font-semibold">
                  oficiálních českých distributorů
                </span>
                .{' '}
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                A protože k modernímu bydlení 21. století patří chytré ovládání, propojíme všechny
                technologie do inteligentní domácnosti, kterou máte pod kontrolou odkudkoliv.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="relative z-20">
              ...
              <div className="text-slate-600 space-y-4 text-base leading-relaxed">
                <p>
                  Máme za sebou roky zkušeností z montážních firem, kde jsme se naučili řemeslo i
                  práci se zákazníky. Ale také jsme si všimli něčeho, co nám vadilo – ústup od
                  poctivého přístupu, zhoršující se servis a snaha ušetřit tam, kde by se naopak
                  mělo přidat. Právě proto jsme založili SFERA PRO DOMOV s.r.o., firmu, která dělá
                  věci tak, jak je považujeme za správné – férově, kvalitně a s
                  respektem k zákazníkům.{' '}
                </p>
                <p className="font-medium text-slate-700">
                  Chceme být důkazem, že nejlepší cesta vede přes dlouhodobou spolupráci, rychlé a
                  vstřícné jednání a telefonní číslo, které zvedáme i po letech. Díky tomu se k nám
                  naši zákazníci s důvěrou vracejí.{' '}
                </p>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-slate-200">
                ...
                <p className="text-sm text-slate-500">
                  Jednatel společnosti SFERA PRO DOMOV s.r.o.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="text-left mt-16">
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                Víme, jak je frustrující, když něco nefunguje a vy se nemůžete dovolat nikomu, kdo
                by to opravil.
                <span className="block bg-gradient-to-r from-[#1B5D93] to-[#49A3D7] bg-clip-text text-transparent font-semibold">
                  {' '}
                  My se schovávat nebudeme.
                </span>
                Vždy jsme na telefonu, abychom Vám poradili a problém odstranili co nejdříve. Akutní
                poruchy řešíme do 3 dnů, v některých případech i do 24h.
              </p>
              <div className="flex items-center gap-4">
                ...
                <span className="text-md text-gray-400 font-medium">
                  Férový přístup a dlouhodobá spolupráce
                </span>
              </div>
            </div>

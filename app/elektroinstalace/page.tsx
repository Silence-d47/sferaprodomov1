        ...
        <section className="relative h-[90vh] min-h-[600px] flex items-center text-white">
          ...
          <div className="relative z-10 container">
            <div className="max-w-3xl">
              <Badge
                variant="outline"
                className="mb-6 bg-orange-500/10 border-orange-500/30 text-white "
              >
                Elektroinstalace
              </Badge>
              <h1 className="text-4xl md:text-6xl font-bold mb-4 leading-tight [text-shadow:_0_2px_8px_rgb(0_0_0_/_50%)] text-white-70">
                Profesionální řešení pro domov i firmu.
              </h1>
              <p className="text-lg md:text-xl text-white mb-8 max-w-2xl [text-shadow:_0_1px_4px_rgb(0_0_0_/_40%)]">
                Náš tým zkušených a pečlivých profesionálů vás přesvědčí,
                <span className="font-bold"> že bezpečí nemusí být jen pocit. </span>
                Nabízíme řešení pro nové instalace, modernizace starých rozvodů, nebo fotovoltaické
                panely.
              </p>
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="text-center group">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Nabízíme moderní řešení pro fotovoltaiku nebo nabíjecí stanici pro váš
                  elektromobil.
                </p>
              </div>
              ...
              <div className="text-center group">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Náš tým tvoří pouze kvalifikovaní a zkušení elektrikáři se všemi potřebnými
                  osvědčeními.
                </p>
              </div>
              ...
              <div className="text-center group">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Víme, že jsme u vás doma, nebo ve firmě. Po naši práci zůstane vždycky čisto a
                  uklizeno.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-all duration-300 border-t-4 border-orange-500">
                ...
                <p className="text-muted-foreground mb-6 text-center">
                  Rodinné domy a byty (kompletní silnoproud i slaboproud)
                </p>
              ...
              <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-all duration-300 border-t-4 border-orange-500">
                ...
                <p className="text-muted-foreground mb-6 text-center">
                  Modernizace starých rozvodů (Al/Cu){' '}
                </p>
                <div className="space-y-3">
                  <h4 className="font-semibold text-sm">Zahrnuje:</h4>
                  <div className="flex items-center text-sm">
              ...
              <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-all duration-300 border-t-4 border-orange-500">
                ...
                <p className="text-muted-foreground mb-6 text-center">
                  Kanceláře, obchody, dílny, sportoviště
                </p>
                <div className="space-y-3">
                  <h4 className="font-semibold text-sm">Zahrnuje:</h4>
                  <div className="flex items-center text-sm">
              ...
              <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-all duration-300 border-t-4 border-orange-500">
                ...
                <p className="text-muted-foreground mb-6 text-center">
                  Rozvaděče, osvětlení, elektroinstalace, zvonky
                </p>
                <div className="space-y-3">
                  <h4 className="font-semibold text-sm">Zahrnuje:</h4>
                  <div className="flex items-center text-sm">
              ...
              <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-all duration-300 border-t-4 border-orange-500">
                ...
                <p className="text-muted-foreground mb-6 text-center">
                  Nabíjecí stanice pro elektromobily, fotovoltaika
                </p>
                <div className="space-y-3">
                  <h4 className="font-semibold text-sm">Zahrnuje:</h4>
                  <div className="flex items-center text-sm">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-slate-200/90 max-w-3xl mx-auto leading-relaxed">
                  Tým našich proškolených a certifikovaných techniků je připraven řešit vaše
                  požadavky od pondělí do neděle od 8:00 do 20:00.
                  <br />
              ...
              <div className="bg-white/15 backdrop-blur-md rounded-3xl p-8 border border-white/30 shadow-2xl max-w-4xl mx-auto mb-12">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  ...
                  <div className="text-center lg:text-left">
                    ...
                    <div className="text-green-900 text-sm font-medium mt-2">
                      ✓ Elektropohotovost Opava
                    </div>
                  ...
                  <div className="text-center lg:text-right">
                    ...
                    <div className="text-slate-200 font-bold text-lg mb-2">
                      Po - Ne 8:00 - 20:00
                    </div>
                    <div className="text-green-900 text-sm font-medium mt-3">
                      ✓ Pohotovostní servis
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Bezplatná konzultace online nebo na místě realizace. Prodiskutujeme vaše
                          potřeby, možnosti a očekávání. Poradíme s výběrem nejlepšího řešení.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Připravíme jasný návrh řešení a přehledný rozpočet. Vše srozumitelně, bez
                          zbytečných komplikací a s důrazem na férovost.{' '}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Dohodneme termín, zajistíme materiál a připravíme vše potřebné. Celou dobu
                          jsme v kontaktu a vy budete vědět přesně, kdy začínáme a jak dlouho bude
                          trvat práce.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Práci provádíme rychle, precizně a čistota je naší prioritou. Používáme
                          pouze kvalitní materiály od renomovaných značek a moderní nástroje. Váš
                          provoz nenarušíme.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Po dokončení společně provedeme revizi, předáme dokumentaci, vysvětlíme
                          funkčnost a zodpovíme vaše otázky. Poskytujeme záruku na všechny práce a
                          materiály.
                        </p>
                      </div>
                    </div>
          ...
          <div className="container relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
                Vše co potřebujete vědět o elektroinstalacích - odpovědi od expertů s více než
                15letou praxí
              </p>
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-bold text-lg mb-3 text-orange-900">
                          Jak dlouho trvá kompletní rekonstrukce elektroinstalace?
                        </h3>
                        <p className="text-muted-foreground mb-4">
                          <strong>Byt 2+1:</strong> 3-5 pracovních dnů
                          <br />
                          <strong>Rodinný dům:</strong> 5-10 pracovních dnů
                          <br />
                          <strong>Firemní objekt:</strong> 1-3 týdny
                        </p>
                        <p className="text-sm text-muted-foreground">
                          Přesný harmonogram vám předložíme před začátkem prací včetně detailního
                          plánu každého dne.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-orange-500">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-bold text-lg mb-3 text-orange-900">
                          Kolik stojí nová elektroinstalace?
                        </h3>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Cena závisí na složitosti, počtu okruhů a kvalitě materiálů. Bezplatná
                          kalkulace na místě.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-orange-500">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-bold text-lg mb-3 text-orange-900">
                          Kdy je nutná revize elektroinstalace?
                        </h3>
                        <div className="space-y-3 mb-4">
                          <div className="flex items-center">
                            <CheckCircle className="h-5 w-5 text-orange-500 mr-3" />
                            <span>
                              <strong>Domácnosti:</strong> Každých 5 let
                            </span>
                          </div>
                          <div className="flex items-center">
                            <CheckCircle className="h-5 w-5 text-orange-500 mr-3" />
                            <span>
                              <strong>Firmy:</strong> Každé 2 roky
                            </span>
                          </div>
                          <div className="flex items-center">
                            <CheckCircle className="h-5 w-5 text-orange-500 mr-3" />
                            <span>
                              <strong>Nová instalace:</strong> Vždy povinná
                            </span>
                          </div>
                          <div className="flex items-center">
                            <CheckCircle className="h-5 w-5 text-orange-500 mr-3" />
                            <span>
                              <strong>Větší změny:</strong> Povinná revize
                            </span>
                          </div>
                        </div>
                        <p className="text-sm text-muted-foreground">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-orange-500">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-bold text-lg mb-3 text-orange-900">
                          Potřebuji přípravu pro elektromobil?
                        </h3>
                        <p className="text-muted-foreground mb-4">
              ...
              <div className="grid lg:grid-cols-2 gap-8 mt-8">
                <div className="space-y-6">
                  {leftDynamicFaqs.map((item, idx) => (
                    ...
                    >
                      <div className="flex items-start space-x-4">
                        <div className="w-8 h-8 bg-orange-900 text-white rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0">
                          Q
                        </div>
                        <div>
                          <h3 className="font-bold text-lg mb-3 text-orange-900">
              ...
              <div className="mt-12 text-center bg-orange-500/10 rounded-2xl p-8 border border-orange-500/20">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button
                    variant="outline"
                    className="border-orange-900 text-orange-900 hover:bg-orange-500"
                    asChild
                  >
        ...
        <section className="py-20 bg-orange-500/50 text-orange-800">
          <div className="container text-center">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto text-orange-900">
              Zatím máte jen nápad, možná máte připravený kompletní plán a chcete začít s realizací?
              Ozvěte se nám, Rádi vám připravíme nezávaznou nabídku.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Button
                ...
                variant="secondary"
                asChild
                className="bg-orange-500/50 font-bold text-orange-00 hover:bg-orange-50"
              >

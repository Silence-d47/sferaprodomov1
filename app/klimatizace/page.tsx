...
const whyChooseUs = [
  {
    ...
    description: 'Naše týmy jsou efektivní. Bez zbytečného čekání.',
  },
  {
    icon: Users,
    title: 'Certifikovaní technici',
    description: 'Práci provádí pouze kvalifikovaní a proškolení odborníci.',
  },
  {
    icon: Shield,
    title: 'Záruka a rychlý servis',
    description: 'Až 5 let záruka na vybrané modely a servisní zásah do 7 dnů.',
  },
  {
    icon: CheckCircle,
...
const acTypes = [
  ...
  },
  {
    ...
    description:
      'Ideální pro jednotlivé místnosti. Snadná instalace, nenáročný montážní zásah a rychlé chlazení/ohřev konkrétního prostoru.',
    advantages: [
  ...
  },
  {
    ...
    description:
      'Jedna venkovní jednotka pro více vnitřních jednotek. Perfektní pro celý dům nebo byt s více místnostmi.',
    advantages: [
  ...
  },
  {
    ...
    description:
      'Pokročilé klimatizační systémy umožňují připojit větší množství vnitřních jednotek k jedné venkovní a nezávisle nastavit teplotu v každé místnosti.',
    advantages: [
      ...
      <div className="bg-white text-slate-800">
        <section className="relative h-[80vh] md:h-[90vh] min-h-[500px] md:min-h-[600px] flex items-center text-white">
          <div className="absolute inset-0">
            <Image
              src="/images/klimatizace_hero.jpg"
              alt="Interiér s klimatizací"
              fill
              priority
          ...
          <div className="relative z-10 container px-4 md:px-6">
            <div className="max-w-3xl">
              <Badge
                variant="outline"
                className="mb-3 md:mb-4 bg-blue-500/40 text-blue-500 border-blue-500/30 text-white text-xs md:text-sm"
              >
              ...
              <p className="text-base md:text-xl text-white/90 mb-6 md:mb-8 max-w-2xl [text-shadow:_0_1px_4px_rgb(0_0_0_/_40%)]">
                Zajistíme profesionální návrh, instalaci a servis klimatizačních systémů. Rychle,
                spolehlivě a s prodlouženou zárukou.
              </p>
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
                ...
                <Button
                  size="lg"
                  asChild
                  className="bg-blue-500 text-white font-semibold hover:bg-blue-600 shadow-lg text-sm md:text-base py-3 md:py-4"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  asChild
                  className="border-blue-500/50 bg-blue-500/10 text-white hover:bg-blue-100/50 backdrop-blur-sm text-sm md:text-base py-3 md:py-4"
                >
          ...
          <div className="container px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-8 md:mb-16">
              <h2 className="text-2xl md:text-4xl font-bold mb-3 md:mb-4">
                Proč si pro klimatizaci vybrat právě nás?
              </h2>
              <p className="text-base md:text-lg text-slate-600">
                Kombinujeme rychlost, odbornost a férový přístup. Vaše spokojenost je pro nás na
                prvním místě.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
              {whyChooseUs.map((reason) => (
                <div
                  key={reason.title}
                  className="bg-white p-4 md:p-6 rounded-xl border border-slate-200/80 text-center transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
                >
        ...
        <section className="py-12 md:py-20 lg:py-28 bg-white">
          <div className="container px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-8 md:mb-16">
              <h2 className="text-2xl md:text-4xl font-bold mb-3 md:mb-4">
                Jaký typ klimatizace je pro vás?
              </h2>
              <p className="text-base md:text-lg text-slate-600">
                Každý dům a každá místnost je jiná. Pomůžeme vám vybrat řešení, které bude přesně
                odpovídat vašim potřebám a možnostem.
              </p>
            </div>
              ...
              {acTypes.map((type, index) => (
                ...
                >
                  <div className="flex items-center gap-3 md:gap-4 mb-3 md:mb-4">
                    ...
                    <h3 className="text-base sm:text-lg md:text-2xl font-bold text-slate-800">
                      {type.title}
                    </h3>
                  </div>
        ...
        <section className="py-12 md:py-20 lg:py-28 bg-blue-200/90 text-slate-800">
          <div className="container px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-8 md:mb-16">
              <h2 className="text-2xl md:text-4xl font-bold mb-3 md:mb-4">
                Od poptávky k pohodlí v 5 krocích
              </h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6 md:gap-8 relative">
                {[
                  ...
                  <div key={index} className="text-center">
                    ...
                    <p className="font-semibold text-xs md:text-sm text-slate-800/90 leading-tight">
                      {item.step}
                    </p>
                  </div>
                ))}
        ...
        <section className="py-12 md:py-20 lg:py-28 bg-white">
          <div className="container px-4 md:px-6">
            <div className="text-center max-w-3xl mx-auto mb-8 md:mb-16">
              ...
              <p className="text-base md:text-lg text-slate-600">
                Podívejte se na ukázky našich realizací klimatizací. Každý projekt je důkazem naší
                kvality a zkušeností.
              </p>
            </div>
            ...
            <div className="text-center mt-8 md:mt-16">
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-slate-300 hover:bg-slate-100 text-sm md:text-base"
              >
                <Link href="/reference">
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="bg-white rounded-lg md:rounded-xl p-4 md:p-6 shadow-lg border-l-4 border-blue-500">
                    <div className="flex items-start space-x-3 md:space-x-4">
                      ...
                      <div>
                        <h3 className="font-bold text-base md:text-lg mb-2 md:mb-3 text-blue-900/90">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center">
                            ...
                            <span className="text-xs md:text-sm">
                              Vnitřní jednotka nasává teplý vzduch z místnosti
                            </span>
                          </div>
                          <div className="flex items-center">
                            <CheckCircle className="h-4 md:h-5 w-4 md:w-5 text-blue-500 mr-2 md:mr-3" />
                            <span className="text-xs md:text-sm">
                              Chladivo vnitřní jednotky absorbujte teplo
                            </span>
                          </div>
                          <div className="flex items-center">
                            <CheckCircle className="h-4 md:h-5 w-4 md:w-5 text-blue-500 mr-2 md:mr-3" />
                          ...
                          <div className="flex items-center">
                            <CheckCircle className="h-4 md:h-5 w-4 md:w-5 text-blue-500 mr-2 md:mr-3" />
                            <span className="text-xs md:text-sm">
                              Venkovní jednotka odvádí teplo ven
                            </span>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-blue-500">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-bold text-lg mb-3 text-blue-900/90">
                          Jaký je rozdíl mezi split a multisplit systémem?
                        </h3>
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-blue-500">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-bold text-lg mb-3 text-blue-900/90">
                          Jak často je potřeba údržba klimatizace?
                        </h3>
                        <div className="space-y-3 mb-4">
                          <div className="flex items-center">
                            <CheckCircle className="h-5 w-5 text-blue-500 mr-3" />
                            <span>
                              <strong>servis a dezinfekce:</strong> 1-2x ročně
                            </span>
                          </div>
                          <div className="flex items-center">
                            <CheckCircle className="h-5 w-5 text-blue-500 mr-3" />
                            <span>
                              <strong>Čištění vnitřní jednotky:</strong> 1x ročně
                            </span>
                          </div>
                          <div className="flex items-center">
                            <CheckCircle className="h-5 w-5 text-blue-500 mr-3" />
                            <span>
                              <strong>Servis venkovní jednotky:</strong> 1x ročně
                            </span>
                          </div>
                        </div>
                        <p className="text-sm text-muted-foreground">
                          Pravidelná údržba zahrnuje dezinfekci, diagnostiku, tlakové zkoušky a
                          čištění. Tím je zajištěna efektivita a dlouhá životnost klimatizace.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-blue-500">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-bold text-lg mb-3 text-blue-900/90">
                          Lze klimatizaci kombinovat s jinými systémy?
                        </h3>
                ...
                <div className="space-y-6">
                  <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-blue-500">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h3 className="font-bold text-lg mb-3 text-blue-900/90">
                          Jaký je energetický štítek klimatizace?
                        </h3>
                        <p className="text-muted-foreground mb-4">
                        ...
                        <p className="text-sm text-muted-foreground mt-3">
                          *A+++ třída u klimatizací bývá často kombinovaná i s topením. V takovém
                          případě je možné čerpat státní dotace &lsquo;Nová zelená
                          úsporám&rsquo;.{' '}
                        </p>
                      </div>
                    </div>

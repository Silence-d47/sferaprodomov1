          ...
          <div className="container">
            <div className="max-w-4xl text-white">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-4 leading-tight drop-shadow-lg">
                Detaily celého projektu
              </h1>
              <p className="text-lg md:text-xl text-blue-100 leading-relaxed max-w-3xl">
                Podívejte se na realizaci a zkušenost klienta. Níže najdete fotografie a technické
                údaje projektu.
              </p>
              <div className="mt-6">
                <Button
                  ...
                  <div className="bg-blue-50 rounded-xl p-6">
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      {reference.technicalSpecs.map((spec, index) => (
                        <div
                          key={index}
                          className="flex justify-between py-2 border-b border-blue-200 last:border-b-0"
                        >
                  ...
                  <div className="bg-green-50 rounded-xl p-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      {reference.projectDetails.projectSize && (
                        <div className="text-center p-3 bg-white rounded-lg">
                          <div className="text-2xl font-bold text-green-600 mb-1">
                            {reference.projectDetails.projectSize}m²
                          </div>
                      ...
                      {reference.projectDetails.duration && (
                        <div className="text-center p-3 bg-white rounded-lg">
                          <div className="text-2xl font-bold text-green-600 mb-1">
                            {reference.projectDetails.duration} dnů
                          </div>
              ...
              <div className="border-t border-gray-200 pt-12">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600">
                    Prohlédněte si fotografie kliknutím. Posouvejte pro zobrazení dalších.
                  </p>
                ...
                <CardContent className="p-0">
                  <div className="bg-gradient-to-r from-blue-50 to-cyan-50 p-8">
                      ...
                      {typeof reference.rating === 'number' && (
                        <div className="flex items-center">
                          {[...Array(5)].map((_, i) => (
                            <Star
                              key={i}
                              className={`h-5 w-5 ${i < (reference.rating ?? 0) ? 'text-yellow-400 fill-current' : 'text-gray-300'}`}
                            />
                          ))}
                    ...
                    <blockquote className="text-lg leading-relaxed text-gray-800 mb-6 italic">
                      &ldquo;{reference.testimonial?.quote}&rdquo;
                    </blockquote>
                    <div className="flex items-center justify-between pt-6 border-t border-blue-200">
                      <div>
                        <div className="font-semibold text-gray-900">
                          {reference.testimonial?.clientName}
                        </div>
                        {reference.testimonial?.clientTitle && (
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed max-w-3xl mx-auto">
              Kontaktujte nás a společně vytvoříme řešení přesně pro vaše potřeby. Každý projekt
              realizujeme s maximální péčí a profesionalitou.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-blue-700 bg-blue-300 text-blue-700 font-bold hover:bg-blue-700 hover:text-white"
                asChild
              >
                <Link href="/reference">Všechny reference</Link>
              </Button>
            </div>
          </div>
        </div>
